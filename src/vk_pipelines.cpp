...
VkPipeline PipelineBuilder::build_pipeline(VkDevice device)
{
	...
	//if a part is to be set as dynamic state, put the enum for it in this array, which is passed to the VkPipelineDynamicStateCreateInfo struct
...
void PipelineBuilder::set_color_attachment_format(VkFormat format)
{
	...
	//NB: this is a pointer. This is so you can add more than one color format, useful for, for example, drawing to more than one
	//image at once
